=== Google Maps Widget - Ultimate Google Map Plugin ===
...
Got a broken Google Map taking hours to setup? With Google Maps Widget you'll have a perfect map with a thumbnail & lightbox in minutes!
...
1. Google Maps Widget - Simple & fast - you'll have a great google map working in under a minute
2. Google Maps Widget - Thumbnail map is shown as a widget and since it's just one image it loads super-fast (1 request, about 20KB)
3. Google Maps Widget - Larger map with all interactive features is available in the lightbox
4. Google Maps Widget - Widget options - Thumbnail map
5. Google Maps Widget - Widget options - Interactive map
6. Google Maps Widget - Widget options - Shortcode
7. Google Maps Widget - Thumbnail map - light color scheme
